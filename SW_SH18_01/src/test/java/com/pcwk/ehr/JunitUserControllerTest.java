...
public class JunitUserControllerTest {
	...
	public void setUp() throws Exception {
		...
		user01 = new UserVO("p04", "김병완04", "4444", Level.BASIC, 1, 0, "rlaqod93@naver.com", "날짜_사용않함");
		user02 = new UserVO("p040", "김병완040", "4444", Level.BASIC, 1, 0, "rlaqod93@naver.com", "날짜_사용않함");
		user03 = new UserVO("p0400", "김병완0400", "4444", Level.GOLD, 100, 31, "rlaqod93@naver.com", "날짜_사용않함");
	...
	public void doRetrieve() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/user/doRetrieve.do")
				...
				.param("pageNum", String.valueOf(searchVO.getPageNum())).param("searchDiv", searchVO.getSearchDiv())
		...
		Gson gson = new Gson();
		List<UserVO> list = gson.fromJson(result, new TypeToken<List<UserVO>>() {
		}.getType());
	...
	@Test
	//
	public void doUpdata() throws Exception {
		// 1. 기존데이터 삭제
		// 2. 단건입력
		// 3. 수정
		// 4. 비교
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/user/doUpdate.do")
				...
				.param("intLevel", user01.getIntLevel() + "").param("login", user01.getLogin() + "")
	...
	@Test
	@Ignore
	public void addAndDGet() throws Exception {
		// 1. 기존데이터 삭제
		// 2. 신규데이터 등록
		// 3. 단건데이터 조회
		// 4. 등록데이터와 비교
	...
	public void doDelete(UserVO user) throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/user/doDelete.do").param("uId",
				user.getuId());
