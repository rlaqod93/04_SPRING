...
public class JunitUserServiceTest {
	...
	public void setUp() throws Exception {
		 ...
		 * 
		 */
		list = Arrays.asList(new UserVO("p04", "김병완04", "4444", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER - 1, 0,
				"rlaqod93@naver.com", "날짜_사용않함") // BASIC
				, new UserVO("p040", "김병완040", "4444", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER, 10, "rlaqod93@naver.com",
						"날짜_사용않함") // BASIC -> SILVER
				, new UserVO("p0400", "김병완0400", "4444", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER + 1,
						MIN_RECOMMEND_FOR_GOLD - 1, "rlaqod93@naver.com", "날짜_사용않함") // SILVER -> SILVER
				, new UserVO("p04000", "김병완04000", "4444", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER + 1,
						MIN_RECOMMEND_FOR_GOLD, "rlaqod93@naver.com", "날짜_사용않함") // SILVER -> GOLD
				, new UserVO("p040000", "김병완040000", "4444", Level.GOLD, MIN_LOGCOUNT_FOR_SILVER + 2,
						MIN_RECOMMEND_FOR_GOLD + 1, "rlaqod93@naver.com", "날짜_사용않함") // GOLD
		);
