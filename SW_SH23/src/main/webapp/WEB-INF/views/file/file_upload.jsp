                ...
                <c:choose>
                  <c:when test="${list.size()>0}">
                      <c:forEach var="vo" items="${list}">
		                  <tr>
		                     <td class="text-left col-sm-2 col-md-2 col-lg-2">${vo.orgFileNm}</td>
		                     <td class="text-left   col-sm-2 col-md-2 col-lg-2">${vo.saveFileNm}</td>
		                     <td class="text-center col-sm-2 col-md-2 col-lg-2">${vo.fileSize}</td>
		                     <td class="text-center col-sm-2 col-md-2 col-lg-2"><img  src="http://localhost:8081/ehr/file/viewImag.do"></td>
