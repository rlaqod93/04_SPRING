            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <select class="form-control" name="fileDiv" id="fileDiv">
						<option class="10">파일</option>
						<option class="20">이미지</option>                    
                    </select>
                </div>
            </div>
            <div class="form-group">
                <label for="title" class="col-sm-3 col-md-2 col-lg-2 control-label">파일1</label>
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="file" maxlength="100" name="file01" id="file01" placeholder="제목" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="title" class="col-sm-3 col-md-2 col-lg-2 control-label">파일2</label>
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="file" maxlength="100" name="file02" id="file02" placeholder="제목" class="form-control">
                </div>
            </div>
            <div class="form-group">
