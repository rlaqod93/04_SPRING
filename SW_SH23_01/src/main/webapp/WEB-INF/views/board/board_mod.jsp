    ...
    <div class="container">
        ...
        <form action="#" class="form-horizontal" method="post">
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="seq" value="<c:out value='${vo.seq}'/>" id="seq" placeholder="순번" class="form-control" readonly>
                </div>
            </div>
            <div class="form-group">
                <label for="title" class="col-sm-3 col-md-2 col-lg-2 control-label">제목</label>
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="title" value="<c:out value='${vo.title}'/>" id="title" placeholder="제목" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="readCnt" class="col-sm-3 col-md-2 col-lg-2 control-label">조회수</label>
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="readCnt" value="<c:out value='${vo.readCnt}'/>" id="readCnt" placeholder="조회수" class="form-control" readonly>
                </div>
            </div>
            <div class="form-group">
                <label for="div" class="col-sm-3 col-md-2 col-lg-2 control-label">게시구분</label>
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="div" id="div" value="<c:out value='${vo.getDiv()}'/>" placeholder="게시구분" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="regId" class="col-sm-3 col-md-2 col-lg-2 control-label">등록자</label>
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="regId" id="regId" value="<c:out value='${vo.regId}'/>" placeholder="등록자" readonly class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="regDt" class="col-sm-3 col-md-2 col-lg-2 control-label">등록일</label>
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="regDt" id="regDt" value="<c:out value='${vo.regDt}'/>" placeholder="등록일" readonly class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="modId" class="col-sm-3 col-md-2 col-lg-2 control-label">수정자</label>
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="modId" id="modId" value="<c:out value='${sessionScope.user.uId}'/>" placeholder="수정자" readonly class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label for="modDt" class="col-sm-3 col-md-2 col-lg-2 control-label">수정일</label>
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="modDt" id="modDt" value="<c:out value='${vo.modDt}'/>" placeholder="수정일" readonly class="form-control">
                </div>
            </div>
            <!-- 내용 -->
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <textarea name="contents" id="contents" cols="20" rows="5" class="form-control"><c:out value='${vo.contents}'/></textarea>
                </div>
            </div>
            <!--//내용 ---------------------------------------->
        </form>
