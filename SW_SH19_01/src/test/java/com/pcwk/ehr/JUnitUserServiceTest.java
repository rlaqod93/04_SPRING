...
//	@Qualifier("dummyMailSender")
	...
	public void setUp() throws Exception {
		 ...
		 */
		list = Arrays.asList(
				new UserVO("p03", "김동호03", "1130", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER-1, 0, "tubus1130@gmail.com", "날짜_사용안함"),         //BASIC
				new UserVO("p030", "김동호030", "1130", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER, 10, "tubus1130@gmail.com", "날짜_사용안함"),      //BASIC->SILVER
				new UserVO("p0300", "김동호0300", "1130", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER+1, MIN_RECOMMEND_FOR_GOLD-1, "tubus1130@gmail.com", "날짜_사용안함"),   //SILVER
				new UserVO("p03000", "김동호03000", "1130", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER+1, MIN_RECOMMEND_FOR_GOLD, "tubus1130@gmail.com", "날짜_사용안함"), //SILVER->GOLD
				new UserVO("p030000", "김동호030000", "1130", Level.GOLD, MIN_LOGCOUNT_FOR_SILVER+2, MIN_RECOMMEND_FOR_GOLD+1, "tubus1130@gmail.com", "날짜_사용안함")  //GOLD
				);
	...
	public void addAndGet() {
		...
		try {
			...
			UserVO voUser01 = userService.doSelectOne(list.get(0));
			isSameUser(voUser01, list.get(0));
			UserVO voUser05 = userService.doSelectOne(list.get(4));
			isSameUser(voUser05, list.get(4));
